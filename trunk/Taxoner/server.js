            ...
            if (fs.statSync(filename).isFile) {
                ...
                var child = exec(cmd, function(error, stdout, stderr) {
                    var result = "<!doctype html>"
                            ...
                            + "<head>"
                            + "<meta charset='utf-8'>"
                            + "<link rel='stylesheet' type='text/css' href='" + htmlURL + "/themes/bartik/css/layout.css' /> "
                            + "<link rel='stylesheet' type='text/css' href='" + htmlURL + "/themes/bartik/css/style.css' />"
                            + "<link rel='stylesheet' type='text/css' href='" + htmlURL + "/themes/bartik/css/colors.css' />"
                            + "</head>"
